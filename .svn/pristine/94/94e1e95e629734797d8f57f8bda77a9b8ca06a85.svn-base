...
public class MyBusinessActivity extends BaseActivity{
    ...
    private TextView tv_enterprise_coding,tv_createtime,tv_location;
    private EditText et_name,et_num,et_address,et_scope_of_business,et_industry,
            et_corporate_representative,et_phone;
    ...
    protected void bindView() {
        ...
        initTitle(R.drawable.ic_left_jt,"我的企业","完成");
    ...
    protected void initView() {
        ...
        et_scope_of_business = findViewById(R.id.et_scope_of_business);
        et_industry = findViewById(R.id.et_industry);
        et_corporate_representative = findViewById(R.id.et_corporate_representative);
    ...
    protected void initData() {
        ...
        et_name.setText((String)GetUserInfo.getData(this,"compname",""));
        et_num.setText((String)GetUserInfo.getData(this,"registercode",""));
        et_address.setText((String)GetUserInfo.getData(this,"address",""));
        et_scope_of_business.setText((String)GetUserInfo.getData(this,"scopmuch",""));
        ...
        et_industry.setText((String)GetUserInfo.getData(this,"trade",""));
        et_corporate_representative.setText((String)GetUserInfo.getData(this,"legalperson",""));
        et_phone.setText((String)GetUserInfo.getData(this,"contectnum",""));
